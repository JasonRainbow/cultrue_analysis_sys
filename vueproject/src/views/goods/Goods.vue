...
<template>
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      ...
      <el-form-item>
        <el-button size="small" round type="primary" icon="el-icon-search" @click="search">搜索</el-button>
        <el-button size="small" round type="primary" icon="el-icon-plus" @click="handleEdit()">添加</el-button>
        <el-button size="small" round type="success">导入数据</el-button>
        <el-button size="small" round type="success">导出数据</el-button>
        <el-button size="small" round type="warning">导出模板</el-button>
      </el-form-item>
    </el-form>
    <!--列表-->
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" label="操作" min-width="300">
        <template slot-scope="scope">
          ...
          <el-button size="small" round icon="el-icon-delete" type="danger" @click="deleteUser(scope.$index, scope.row)"></el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->

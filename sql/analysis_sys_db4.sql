...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'root', '$2a$10$BI3efZhPjRpx5G8UpSYPsuDiKETSAgjYjDRUxvy86ToR217BwcMua', '超级管理员', 1, '/api/files/28c3e15a93964a1e82ecc36efb2182c5', '16680802519', '1966752024@qq.com');
...
INSERT INTO `admin` VALUES (11, 'hzx', '$2a$10$0DdzGYL3gx5BT2g84esALuHUDTbweBhAOmjHdC2z8HnzH2ZpD3cCi', '黄志祥', 2, 'http://localhost:9090/api/files/fb55d8449da045d3b227201b45611d1d', NULL, NULL);
...
INSERT INTO `monitor_request` VALUES (12, 22, 7, '2023-07-01 19:43:25', 1, 0);
...
INSERT INTO `monitor_request` VALUES (40, 26, 18, '2023-07-13 01:13:18', 1, 0);
INSERT INTO `monitor_request` VALUES (41, 26, 16, '2023-07-13 14:09:23', 0, 0);
...
-- ----------------------------
INSERT INTO `monitor_work` VALUES (1, '西游记', '影视', '2023-07-01 00:00:00', NULL, 1, 1, 1, 0, 0, 0);
INSERT INTO `monitor_work` VALUES (2, '流浪地球', '影视', '2023-07-01 00:00:00', NULL, 1, 1, 1, 0, 0, 0);
INSERT INTO `monitor_work` VALUES (4, '流浪地球2', '影视', '2023-07-02 19:41:52', NULL, 1, 0, 0, 0, 0, 0);
INSERT INTO `monitor_work` VALUES (5, '李子柒短视频', '影视', '2023-07-02 19:45:32', NULL, 1, 0, 0, 0, 0, 0);
...
INSERT INTO `monitor_work` VALUES (16, '超级工程', '影视', '2023-07-09 18:11:48', NULL, 0, 0, 0, 0, 0, 0);
INSERT INTO `monitor_work` VALUES (17, '水浒传', '影视', '2023-07-09 18:31:41', NULL, 0, 0, 0, 0, 0, 0);
INSERT INTO `monitor_work` VALUES (18, '舌尖上的中国', '影视', '2023-07-13 01:13:18', NULL, 0, 0, 0, 0, 0, 0);
...
INSERT INTO `polarity_analy` VALUES (4, 1, '美国', '2023-07-01', 'Twitter', 46, 20, 15);
...
INSERT INTO `polarity_analy` VALUES (57, 2, '英国', '2023-07-01', 'Youtube', 60, 30, 20);
INSERT INTO `polarity_analy` VALUES (58, 1, '美国', '2023-01-02', 'Youtube', 60, 26, 32);
INSERT INTO `polarity_analy` VALUES (59, 1, '美国', '2023-03-02', 'Youtube', 54, 35, 26);
INSERT INTO `polarity_analy` VALUES (60, 1, '美国', '2023-04-01', 'Youtube', 58, 23, 35);
INSERT INTO `polarity_analy` VALUES (61, 1, '法国', '2023-07-01', 'Youtube', 57, 34, 28);
...
-- ----------------------------
INSERT INTO `sentiment_analy` VALUES (1, 1, '美国', '2023-06-29', 'Youtube', 36, 21, 8, 4, 3, 2);
...
INSERT INTO `sentiment_analy` VALUES (89, 1, '俄罗斯', '2023-07-01', 'Youtube', 60, 40, 36, 34, 23, 16);
INSERT INTO `sentiment_analy` VALUES (90, 1, '加拿大', '2023-07-01', 'Youtube', 60, 44, 34, 27, 25, 18);
INSERT INTO `sentiment_analy` VALUES (91, 1, '德国', '2023-07-01', 'Youtube', 60, 36, 35, 26, 24, 19);
INSERT INTO `sentiment_analy` VALUES (94, 2, '美国', '2023-07-01', 'Youtube', 60, 37, 26, 9, 6, 2);
INSERT INTO `sentiment_analy` VALUES (95, 2, '美国', '2023-07-01', 'Instagram', 44, 40, 27, 10, 4, 6);
INSERT INTO `sentiment_analy` VALUES (96, 2, '美国', '2023-07-01', 'Twitter', 40, 32, 20, 8, 9, 2);
INSERT INTO `sentiment_analy` VALUES (97, 2, '美国', '2023-07-02', 'Youtube', 38, 36, 26, 4, 5, 3);
INSERT INTO `sentiment_analy` VALUES (98, 2, '美国', '2023-07-02', 'Instagram', 69, 25, 20, 3, 8, 4);
INSERT INTO `sentiment_analy` VALUES (99, 2, '美国', '2023-07-02', 'Twitter', 30, 36, 20, 7, 6, 6);
INSERT INTO `sentiment_analy` VALUES (100, 2, '美国', '2023-07-03', 'Youtube', 55, 34, 28, 4, 6, 2);
INSERT INTO `sentiment_analy` VALUES (101, 2, '美国', '2023-07-03', 'Instagram', 56, 30, 19, 7, 7, 3);
INSERT INTO `sentiment_analy` VALUES (102, 2, '美国', '2023-07-03', 'Twitter', 44, 38, 18, 8, 3, 4);
INSERT INTO `sentiment_analy` VALUES (103, 2, '英国', '2023-07-01', 'Youtube', 54, 37, 20, 5, 9, 5);
INSERT INTO `sentiment_analy` VALUES (104, 2, '法国', '2023-07-01', 'Youtube', 48, 37, 15, 6, 10, 3);
INSERT INTO `sentiment_analy` VALUES (105, 2, '英国', '2023-07-01', 'Instagram', 47, 30, 20, 8, 9, 2);
INSERT INTO `sentiment_analy` VALUES (106, 2, '英国', '2023-07-01', 'Twitter', 40, 32, 28, 6, 15, 1);
INSERT INTO `sentiment_analy` VALUES (107, 2, '英国', '2023-07-02', 'Youtube', 44, 35, 20, 10, 8, 3);
INSERT INTO `sentiment_analy` VALUES (108, 2, '英国', '2023-07-02', 'Instagram', 58, 26, 16, 7, 10, 5);
INSERT INTO `sentiment_analy` VALUES (109, 2, '英国', '2023-07-02', 'Twitter', 49, 34, 17, 7, 5, 3);
INSERT INTO `sentiment_analy` VALUES (110, 2, '英国', '2023-07-03', 'Youtube', 67, 30, 20, 10, 6, 2);
INSERT INTO `sentiment_analy` VALUES (111, 2, '英国', '2023-07-03', 'Instagram', 45, 26, 15, 5, 3, 1);
INSERT INTO `sentiment_analy` VALUES (112, 2, '英国', '2023-07-03', 'Twitter', 54, 36, 16, 7, 5, 2);
INSERT INTO `sentiment_analy` VALUES (113, 2, '法国', '2023-07-01', 'Instagram', 44, 43, 18, 5, 5, 1);
INSERT INTO `sentiment_analy` VALUES (114, 2, '法国', '2023-07-01', 'Twitter', 38, 36, 23, 5, 8, 2);
INSERT INTO `sentiment_analy` VALUES (115, 2, '法国', '2023-07-02', 'Youtube', 44, 43, 26, 8, 9, 2);
INSERT INTO `sentiment_analy` VALUES (116, 2, '法国', '2023-07-02', 'Instagram', 54, 26, 18, 8, 9, 1);
INSERT INTO `sentiment_analy` VALUES (117, 2, '法国', '2023-07-02', 'Twitter', 43, 36, 17, 5, 5, 4);
INSERT INTO `sentiment_analy` VALUES (118, 2, '法国', '2023-07-03', 'Youtube', 45, 30, 20, 8, 4, 2);
INSERT INTO `sentiment_analy` VALUES (119, 2, '法国', '2023-07-03', 'Instagram', 53, 34, 26, 9, 6, 1);
INSERT INTO `sentiment_analy` VALUES (120, 2, '法国', '2023-07-03', 'Twitter', 46, 36, 16, 6, 5, 4);
...
CREATE TABLE `user`  (
  ...
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户的姓名',
...
INSERT INTO `user` VALUES (26, 'hzx', '黄志祥', '$2a$10$otmMXO71QG/qfaaiLEagY.yleEEDIMaSsS9yy8LvH5J8HaJ/wN03a', '腾讯', '1966752024@qq.com', '16680802519', 'http://localhost:9090/api/files/0d160a4012d04cc59e6b5bb3f08dd383');
...
INSERT INTO `user` VALUES (64, '1', '2', '$2a$10$t7oMlu/bOeWENfU/NkhtL.kxB.ujbNsXwIoKXNpbMrqhAJix3ghdG', '2', '2436343665@qq.com', '13156473647', NULL);
INSERT INTO `user` VALUES (65, '2', 'si', '$2a$10$D5HFGnBiTXCt.Kf.8S3fIe.HJLtIsCscugR4LmQ.qRHOOVlSCsB6a', '华为', '172865345@qq.com', '13135316758', NULL);
INSERT INTO `user` VALUES (66, '3', 'san', '$2a$10$QpIK1.mm7OjPx.qvyAhVgOT34ISlKJ5pmBixSPh/APZgX6KedBeb2', 'li', '172464526@qq.com', '13135675648', NULL);
INSERT INTO `user` VALUES (69, 'huangzhixiang', '黄志祥', '$2a$10$0vAWu7sWBsaVySJTz/PoFuHVu8BmRtBjo2qE1zb5x27HT1.cCZw8y', '湖南师范大学', '1966752024@qq.com', '15073548315', NULL);
INSERT INTO `user` VALUES (70, 'Allen789', 'Allen', '$2a$10$tj2qySzqPmuEUrGyNMGAJ.8MAopo7r3tOom/pOyQge6/ipdgEahSC', '字节跳动', '3123456234@qq.com', '15326473678', NULL);
INSERT INTO `user` VALUES (71, 'huang', '黄志祥', '$2a$10$5yeP62A8FLBKDQrAZzJSxey6DNsVLGog0AIuKO3FTU3f9LB/ZcFPa', '湖南师范大学', '1966752024@qq.com', '15073548315', NULL);
INSERT INTO `user` VALUES (72, 'huangzh', '黄志祥', '$2a$10$rFpt0kq87/xkXfUTt8Hob.dVnXaV3V8HFDQ6ZzqEapHlHlMSVMlBG', '湖南师范大学', '12312@qq.com', '15073548315', NULL);
INSERT INTO `user` VALUES (73, 'huangzhi', '黄志祥', '$2a$10$ffRyTeCBogVRZXDzsf2m9O3CuJdCVQPMwae8fSp7T5MUu6NYVtPH.', '湖南师范大学', '12312@qq.com', '15073548315', NULL);
...
CREATE TABLE `word_freq_analy`  (
  ...
  `polarity` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '评论中的高频词的情感极性数组',
  `keywords` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '评论中出现的高频词数组',
  `frequency` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '评论中出现的高频词频数数组',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `word_freq_analy` VALUES (1, 1, '美国', '2023-07-01', 'Youtube', '正面 正面 负面 负面 正面 正面 正面 正面', '经典 名著 老土 剧情奇怪 无法超越 了不起 美好 耐人寻味', '10 15 8 6 14 20 25 32');
INSERT INTO `word_freq_analy` VALUES (5, 2, '美国', '2023-07-01', 'Youtube', '正面 正面 正面 正面 正面 正面 正面 正面 负面 正面 正面 正面 中性 中性 负面 负面 正面 负面 正面 正面 中性 中性 正面 正面 正面 中性 正面 正面 负面 中性 中性 负面 正面 负面 中性 正面 负面 中性 中性 中性 中性 负面 正面 正面 中性 正面 中性 正面 中性 正面 负面 正面 正面 中性 正面 正面 负面 正面 负面 中性 正面 中性 正面 中性 负面 负面 正面 正面 正面 正面 中性 正面 中性 正面 正面 正面 正面 中性 中性 正面 正面 正面 中性 中性 正面 正面 正面 中性 正面 负面 中性 正面 负面 正面 正面 正面 正面 正面 正面 中性', '地球 流浪 生命 数字 电影 文明 人类 科幻 人類 世界 中国 宇宙 moss 意识 计划 笨笨 呼吸 图恒宇 危机 電影 感觉 丫丫 政治 黑暗 拯救 MOSS 理解 未来 一個 政府 領導 谢可寅 现实 感覺 特效 喜欢 沒有 木星 解说 时间 中共 謝可寅 森林 第一部 东西 穿越 第二部 解析 意識 一部 整個 观点 什麼 视频 法则 美国 好听 这部 太空 希望 确实 地方 思想 無法 解决 已經 角度 支持 人性 想法 一句 和平 TangoZ 太阳 导演 生存 好看 层次 技术 作品 中國 马兆 有人 影片 预测 情感 法轮 发现 人体 脫離 一辈 月球 台灣 科学家 思考 正确 矛盾 社会 自由 好像', '83 53 47 40 37 35 32 25 25 23 20 18 17 14 14 13 13 13 13 13 12 12 12 12 11 11 11 11 10 10 9 9 9 9 9 9 9 8 8 8 8 8 8 8 8 8 8 8 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 5 5 5 5 5 5');

...
INSERT INTO `monitor_request` VALUES (34, 68, 9, '2023-07-09 20:37:09', 0, 0);
INSERT INTO `monitor_request` VALUES (35, 67, 9, '2023-07-09 20:53:48', 0, 0);
...
INSERT INTO `user` VALUES (26, 'hzx', '黄志祥', '$2a$10$nrfjC0EbbVMM6fxapQEFiOdTREtTAWRlUFbSaG28bXSPuxAthLQVq', '华为', '1966752024@qq.com', '15073548315', 'http://localhost:9090/api/files/0d160a4012d04cc59e6b5bb3f08dd383');
...
INSERT INTO `user` VALUES (67, '12345', '张三', '$2a$10$TCbs.Ln.uKzqJD5CXSK93Oi9a3MWitWWfrIRsTy5R4wfd2OuCO6TK', '腾讯', '2565375377@qq.com', '15115936276', NULL);
INSERT INTO `user` VALUES (68, '123', '张三', '$2a$10$/o7X1obhvNRXPWMYR5xh9.5.hNMu5o9htNusDzwy15.YM5ezB7MnS', '华为', '2573746744@qq.com', '15115936387', NULL);
...
CREATE TABLE `word_freq_analy`  (
  ...
  `polarity` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评论中的高频词的情感极性数组',
  `keywords` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评论中出现的高频词数组',
  `frequency` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评论中出现的高频词频数数组',
  PRIMARY KEY (`id`) USING BTREE,
